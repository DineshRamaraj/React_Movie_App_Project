...
class Upcoming extends Component {
  ...
  getMoviesList = async () => {
    ...
    const apiUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=${apiKey}&language=en-US&page=${currentPageNo}`
  ...
  render() {
    return <div className="upcoming-container">{this.renderMainView()}</div>
  }
}
